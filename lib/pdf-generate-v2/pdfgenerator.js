 ...
 */
const GeneratePDFFromHTML = async (contentHTML, pdfmakeDefinition = undefined, pdfmakeStyle = undefined, data = undefined) => {
  // Input validation
  ...
  const pdfDocumentContent = htmlToPdfMake(contentHTML, { window, defaultStyles: pdfmakeStyle, removeExtraBlanks: true })
